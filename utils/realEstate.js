...
export const REAL_ESTATE_LIST = [
  { id: 1, name: 'Haus 1', preis: '100.000 €' },
  { id: 2, name: 'Haus 2', preis: '380.000 €' },
  { id: 3, name: 'Haus 3', preis: '330.000 €' },
  { id: 4, name: 'Haus 4', preis: '140.000 €' },
  { id: 5, name: 'Haus 5', preis: '140.000 €' },
  { id: 6, name: 'Haus 6', preis: '140.000 €' },
  { id: 7, name: 'Haus 7', preis: '140.000 €' },
  { id: 8, name: 'Haus 8', preis: '190.000 €' },
  { id: 9, name: 'Haus 9', preis: '200.000 €' },
  { id: 10, name: 'Haus 10', preis: '300.000 €' },
  { id: 11, name: 'Haus 11', preis: '140.000 €' },
  { id: 12, name: 'Haus 12', preis: '360.000 €' },
  { id: 13, name: 'Haus 13', preis: '140.000 €' },
  { id: 14, name: 'Haus 14', preis: '140.000 €' },
  { id: 15, name: 'Haus 15', preis: '200.000 €' },
  { id: 16, name: 'Haus 16', preis: '250.000 €' },
  { id: 17, name: 'Haus 17', preis: '140.000 €' },
  { id: 18, name: 'Haus 18', preis: '300.000 €' },
  { id: 19, name: 'Haus 19', preis: '300.000 €' },
  { id: 20, name: 'Haus 20', preis: '15.000 €' },
  { id: 21, name: 'Haus 21', preis: '180.000 €' },
  { id: 22, name: 'Haus 22', preis: '190.000 €' },
  { id: 23, name: 'Haus 23', preis: '150.000 €' },
  { id: 24, name: 'Haus 24', preis: '300.000 €' },
  { id: 25, name: 'Haus 25', preis: '180.000 €' },
  { id: 26, name: 'Haus 26', preis: '180.000 €' },
  { id: 27, name: 'Haus 27', preis: '200.000 €' },
  { id: 28, name: 'Haus 28', preis: '180.000 €' },
  { id: 29, name: 'Haus 29', preis: '170.000 €' },
  { id: 30, name: 'Haus 30', preis: '200.000 €' },
  { id: 31, name: 'Haus 31', preis: '320.000 €' },
  { id: 32, name: 'Haus 32', preis: '240.000 €' },
  { id: 33, name: 'Haus 33', preis: '450.000 €' },
  { id: 34, name: 'Haus 34', preis: '380.000 €' },
  { id: 35, name: 'Haus 35', preis: '200.000 €' },
  { id: 36, name: 'Haus 36', preis: '400.000 €' },
  { id: 37, name: 'Haus 37', preis: '220.000 €' },
  { id: 38, name: 'Haus 38', preis: '350.000 €' },
  { id: 39, name: 'Haus 39', preis: '380.000 €' },
  { id: 40, name: 'Haus 40', preis: '500.000 €' },
  { id: '41A', name: 'Haus 41A', preis: '320.000 €' },
  { id: '41B', name: 'Haus 41B', preis: '320.000 €' },
  { id: 42, name: 'Haus 42', preis: '220.000 €' },
  { id: 43, name: 'Haus 43', preis: '500.000 €' },
  { id: 44, name: 'Haus 44', preis: '350.000 €' },
  { id: 45, name: 'Haus 45', preis: '220.000 €' },
  { id: 46, name: 'Haus 46', preis: '400.000 €' },
  { id: 47, name: 'Haus 47', preis: '380.000 €' },
  { id: 48, name: 'Haus 48', preis: '60.000 €' },
  { id: 49, name: 'Haus 49', preis: '80.000 €' },
  { id: 50, name: 'Haus 50', preis: '50.000 €' },
  { id: 51, name: 'Haus 51', preis: '60.000 €' }
];
